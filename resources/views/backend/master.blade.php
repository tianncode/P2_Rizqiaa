...
<!--
Author: Keenthemes
Product Name: KeenProduct Version: 3.1.1
Purchase: https://keenthemes.com/products/keen-html-pro
...
<!-- Mirrored from preview.keenthemes.com/keen/demo9/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Sep 2025 14:58:03 GMT -->
...
<div class="d-flex flex-grow-1 flex-lg-grow-0">
    ...
    <div class="d-flex align-items-center me-7" id="kt_app_header_logo_wrapper">
        ...
        <button class="d-lg-none btn btn-icon btn-color-white btn-active-color-primary w-35px h-35px ms-n2 me-2" id="kt_app_header_menu_toggle">
            <i class="ki-duotone ki-abstract-14 fs-2"><span class="path1"></span><span class="path2"></span></i>        </button>
        <!--end::Header toggle-->
...
>   
    ...
    <div 
        ...
        data-kt-menu="true"
    >        
        <!--begin:Menu item--><div  data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"  class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2" ><!--begin:Menu link--><span class="menu-link py-3"  ><span  class="menu-title" >Dashboards</span><span  class="menu-arrow d-lg-none" ></span></span><!--end:Menu link--><!--begin:Menu sub--><div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-600px" ><!--begin:Dashboards menu-->
...
<div class="app-navbar flex-shrink-0"> 
    ...
    <div class="app-navbar-item ms-3" id="kt_header_user_menu_toggle">
        ...
        <div class="text-end d-none d-sm-flex flex-column justify-content-center me-3">
            <a href="pages/user-profile/overview.html" class="text-white text-hover-primary fs-6 fw-bold">Carles</a>
        ...
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="d-flex flex-column">
                <div class="fw-bold d-flex align-items-center fs-5">
                    Carles                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
                </div>
...
<!--end::Menu-->
    ...
    <div class="app-navbar-item ms-3">
        <!--begin::Menu- wrapper-->
        <a href="authentication/layouts/corporate/sign-in.html" class="btn btn-icon btn-icon-white btn-active-color-primary btn-custom w-35px h-35px w-md-40px h-md-40px">
            <i class="ki-duotone ki-entrance-left fs-2"><span class="path1"></span><span class="path2"></span></i>        </a>         
        <!--end::Menu wrapper-->
    </div>
    <!--end::Link-->    
...
<div class="w-100 d-flex flex-stack">
    ...
    <div class="d-flex flex-stack me-5">
        ...
        <div class="d-flex gap-1 gap-lg-2">
                ...
                <a href="#" class="custom-link rounded px-lg-4 py-lg-2 d-flex flex-center">
                                            <!--begin::Flag-->                    
                        <img src="assets/media/svg/brand-logos/google-icon.svg" class="w-20px" alt=""/>                     
                        <!--end::Flag--> 
                ...
                <a href="#" class="custom-link rounded px-lg-4 py-lg-2 d-flex flex-center">
                                            <!--begin::Flag-->                    
                        <img src="assets/media/svg/brand-logos/facebook-3.svg" class="w-20px" alt=""/>                     
                        <!--end::Flag--> 
                                         
                    
                    <span class="d-none d-lg-inline text-muted fw-bold text-hover-primary fs-5 ps-3">Facebook</span>                         
                </a>
                <!--end::Link-->
                ...
                <a href="#" class="custom-link rounded px-lg-4 py-lg-2 d-flex flex-center">
                    ...
                    <span class="d-none d-lg-inline text-muted fw-bold text-hover-primary fs-5 ps-3">Instagram</span>                         
                </a>
                <!--end::Link-->
                ...
                <a href="#" class="custom-link rounded px-lg-4 py-lg-2 d-flex flex-center">
                                            <!--begin::Flag-->                    
                        <img src="assets/media/svg/brand-logos/linkedin-1.svg" class="w-20px" alt=""/>                     
                        <!--end::Flag--> 
                                         
                    
                    <span class="d-none d-lg-inline text-muted fw-bold text-hover-primary fs-5 ps-3">LinkedIn</span>                         
                </a>
                <!--end::Link-->
                ...
                <!--begin::Link-->
                <a href="#" class="custom-link rounded px-lg-4 py-lg-2 d-flex flex-center">
                                            <i class="ki-duotone ki-abstract-13 fs-2x text-gray-600"><span class="path1"></span><span class="path2"></span></i>                 
                                         
                    
                    <span class="d-none d-lg-inline text-muted fw-bold text-hover-primary fs-5 ps-3">Upcoming</span>                         
                </a>
                <!--end::Link-->
    ...
    <!--begin::Actions-->       
    <a href="#" class="btn btn-sm btn-primary py-3"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">
        Create
...
<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
    ...
    <li class="menu-item"><a href="https://keenthemes.com/products/keen-html-pro" target="_blank" class="menu-link px-2">Purchase</a></li>
</ul>
<!--end::Menu-->    </div>
<!--end::Footer-->                            </div>
            <!--end:::Main-->
...
<!--end::Card header-->
		...
		<div class="card-body position-relative" id="kt_app_layout_builder_body">
			...
			<div id="kt_app_settings_content"
				...
				<!--begin::Form-->
				<form class="form" method="POST" id="kt_app_layout_builder_form" action="https://preview.keenthemes.com/keen/demo9/index.php">
	...
	<div class="row " data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					...
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="assets/media/preview/demos/demo9/light-ltr.png" class="form-check-rounded mw-100" alt=""/>                      
					</div>
					<!--end::Image--> 
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					<!--begin::Image--> 
					<div class="form-check-wrapper border-gray-200 border-2">
						<img src="assets/media/preview/demos/demo9/dark-ltr.html" class="form-check-rounded mw-100" alt=""/>                      
					</div>
					<!--end::Image--> 
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="overflow-auto pb-5">
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">   
                    <!--begin::Icon-->                                  
                    <img alt="/keen/demo9/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/doc.svg"/>
                    <!--end::Icon--> 
                ...
                <div class="d-flex flex-aligns-center">   
                    <!--begin::Icon-->                                  
                    <img alt="/keen/demo9/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/css.svg"/>
                    <!--end::Icon--> 
                ...
                <div class="mb-0">
					...
					<div class="mb-7">
						<div class="d-flex flex-stack">
							...
							<a href="https://keenthemes.com/" class="fw-semibold" target="_blank">
								License FAQs
							</a>
						</div>
					</div>
					<!--end::Heading-->
						...
						<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
							<div class="d-flex flex-stack">
								...
								<div class="text-nowrap">
									...
									<span class="text-gray-900 fs-1 fw-bold">99</span>
								</div>
							</div>
						</div>
						<!--end::License-->
						...
						<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
							<div class="d-flex flex-stack">
								...
								<div class="text-nowrap">
									<span class="text-muted fs-7 fw-semibold me-n1">$</span>
									<span class="text-gray-900 fs-1 fw-bold">199</span>
								</div>
							</div>
						</div>
						<!--end::License-->
						...
						<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
							<div class="d-flex flex-stack">
								...
								<div class="text-nowrap">
									<span class="text-muted fs-7 fw-semibold me-n1">$</span>
									<span class="text-gray-900 fs-1 fw-bold">299</span>
								</div>
							</div>
						</div>
						<!--end::License-->
					...
					<!--begin::Purchase-->
					<a href="https://keenthemes.com/products/keen-html-pro" class="btn btn-primary fw-bold mb-15 w-100">
						Buy Now
					</a>    
					<!--end::Purchase-->
...
<span class="ms-1"  data-bs-toggle="tooltip" title="Enter one or more location points for more specific targeting." >
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            ...
            <!--begin::Tagify-->
            <input class="form-control d-flex align-items-center" value="" id="kt_modal_create_campaign_location" data-kt-flags-path="/keen/demo9/assets/media/flags/"/>
            <!--end::Tagify-->
        </div>
        <!--end::Input group-->
...
<!--end::Modal - Create App--><!--begin::Modal - New Card-->
...
<!-- Mirrored from preview.keenthemes.com/keen/demo9/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Sep 2025 15:01:57 GMT -->
</html>